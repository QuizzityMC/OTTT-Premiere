// Video Player Controller for "On Track to Terror" Premiere
...
videoPlayer.addEventListener('error', (e) => {
    ...
    alert('Error loading video. Please ensure the video file "on-track-to-terror.mp4" is in the same directory as this HTML file.');
});

console.log('Video player initialized for "On Track to Terror" premiere');
